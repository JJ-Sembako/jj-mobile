package com.dr.jjsembako.akun.presentation.change_password
...
fun GantiKataSandiScreen(
    ...
    val isValidOldPassword = rememberSaveable { mutableStateOf(false) }
    ...
    val errMsgOldPassword = rememberSaveable { mutableStateOf("") }
