...
class PilihPelangganViewModel @Inject constructor(private val fetchSelectCustUseCase: FetchSelectCustUseCase) :
    ...
    private val _customerState: MutableStateFlow<PagingData<DataCustomerOrder>> =
        MutableStateFlow(value = PagingData.empty())
    val customerState: MutableStateFlow<PagingData<DataCustomerOrder>> get() = _customerState
